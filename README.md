...
**ywty** 是一款**自托管图床 / 云相册**系统：从经典 ywty 完全重写而来，后端从 PHP/Laravel 迁移到 **Go + Gin + GORM**，前端从 Vue 3 + Vite 升级到 **Nuxt 3 SSR**。
...
> 历史背景：本项目从 ywty (ywty) 2.x 完全重写而来。ywty 的历史版本更新日志保留在 [CHANGELOG.md](./CHANGELOG.md) 中以供溯源。
